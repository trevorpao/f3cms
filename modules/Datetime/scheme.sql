...
--
-- 資料表結構 `tbl_datetime_meta`
--

CREATE TABLE `tbl_datetime_meta` (
  `id` int(11) NOT NULL,
...
--
-- 資料表結構 `tbl_datetime_tag`
--

CREATE TABLE `tbl_datetime_tag` (
...
--
-- 資料表索引 `tbl_datetime_tag`
--
ALTER TABLE `tbl_datetime_tag`
  ADD PRIMARY KEY (`datetime_id`,`tag_id`);
